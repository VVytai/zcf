...
2. 在每个 Worktree 中运行工作流
   - 在 solution1 中：`/workflow 开发xxx功能`
   - 在 solution2 中：`/workflow 开发xxx功能，要求高性能`
   - 在 solution3 中：`/workflow 开发xxx功能，要求简洁代码`
...
# 在新工作区中，引用工作区2的经验
/workflow 开发xxx功能，参考solution2的实现，但要避免xxx问题
```
...
# Worktree 2：优化实现
/workflow 实现用户登录功能，使用JWT，支持刷新token

# Worktree 3：测试实现
/workflow 实现用户登录功能，重点考虑安全性
```
...
```text
# 在新 Worktree 中继续任务
/workflow 继续开发xxx功能，参考之前的进度文档：progress.md
```
