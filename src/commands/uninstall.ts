...
/**
 * Main uninstall command - Remove ZCF configurations and tools for Claude Code.
 *
 * Codex uninstallation is handled by the Codex adapter; this legacy command
 * remains as the Claude Code-specific implementation.
 */
